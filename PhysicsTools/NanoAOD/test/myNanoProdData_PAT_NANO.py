...
# with command line options: myNanoProdData -s PAT,NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 106X_dataRun2_v11 --era Run2_2018,run2_nanoAOD_102Xv1 --runUnscheduled
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:D6ED7520-C256-4540-BB9A-71ACFA322F0A.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('myNanoProdData_PAT_NANO.root'),
