...
singleRPTable = cms.EDProducer("SimpleProtonTrackFlatTableProducer",
    ...
    externalVariables = cms.PSet(
        decRpId = ExtVar("singleRPProtons:protonsDetId",int,doc="Detector ID",precision=10),
        sector45 = ExtVar("singleRPProtons:sector45",bool,doc="LHC sector 45"),
        sector56 = ExtVar("singleRPProtons:sector56",bool,doc="LHC sector 56"),
    ),
)
...
multiRPTable = cms.EDProducer("SimpleProtonTrackFlatTableProducer",
    ...
    externalVariables = cms.PSet(
        sector45 = ExtVar("multiRPProtons:sector45",bool,doc="LHC sector 45"),
        sector56 = ExtVar("multiRPProtons:sector56",bool,doc="LHC sector 56"),
    ),
)



protonTables = cms.Sequence(singleRPProtons
                            +multiRPProtons
                            +singleRPTable
                            +multiRPTable
)
